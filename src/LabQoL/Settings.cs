...
namespace Random_Features
{
    public class RandomFeaturesSettings : SettingsBase
    {
        public RandomFeaturesSettings()
        {
            ...
            // Fuck Roman Numerals
            FrnMain                    = true;
            FrnBackgroundBoxExtraWidth = new RangeNode<int>(3,   0, 20);
            FrnBackgroundBoxWidth      = new RangeNode<int>(24,  1, 50);
            FrnBackgroundBoxHeight     = new RangeNode<int>(24,  1, 50);
            FrnNextBoxOffset           = new RangeNode<int>(66,  1, 200);
            FrnFirstTierRowX           = new RangeNode<int>(55,  1, 200);
            FrnFirstTierRowY           = new RangeNode<int>(207, 1, 200);
            FrnSecondTierRowX          = new RangeNode<int>(82,  1, 200);
            FrnSecondTierRowY          = new RangeNode<int>(274, 1, 400);
            FrnFontSize                = new RangeNode<int>(20,  1, 40);
            // Wheres My Cursor
            WmcMain                  = true;
