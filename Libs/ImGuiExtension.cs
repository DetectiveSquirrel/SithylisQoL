    ...
    public class ImGuiExtension
    {
        ...
        */
        ...
        public static void ImGuiExtension_ColorTabs(string idString, int height, IReadOnlyList<string> settingList, ref int selectedItem, ref int uniqueIdPop)
        {
            ...
            var boxRegion = new System.Numerics.Vector2(contentRegion.X, height);
            ...
            if (ImGui.BeginChild(idString, boxRegion, true, ImGuiWindowFlags.HorizontalScrollbar))
            {
                for (var i = 0; i < settingList.Count; i++)
                {
                    ...
                    float r, g, b;
                    ImGui.ColorConvertHSVtoRGB(hue, 0.6f, 0.6f, out r, out g, out b);

                    ImGui.PushStyleColor(ImGuiCol.Button, new System.Numerics.Vector4(r, g, b, 0.8f));
                    ImGui.PushStyleColor(ImGuiCol.ButtonHovered, new System.Numerics.Vector4(r, g, b, 0.9f));
                    ImGui.PushStyleColor(ImGuiCol.ButtonActive, new System.Numerics.Vector4(r, g, b, 1.0f));
        ...
        {
            var contentRegion = ImGui.GetContentRegionAvail();
            var boxRegion = new ImGuiVector2(contentRegion.X);
            return ImGui.BeginChild(id, boxRegion, border, flags);
        }
